...
function SkillDriver:BeginAssistAttack(SkillObj)
    return self.AssistAttack:BeginAssistAttack(SkillObj)
end

function SkillDriver:ResetAssistAttackTarget()
    self.AssistAttack:ResetAssistAttackTarget()
end
