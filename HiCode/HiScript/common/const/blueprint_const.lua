...
_M.OfficeDecorationComponent = '/Game/Blueprints/Office/BP_OfficeDecorationComponent.BP_OfficeDecorationComponent_C'
...
_M.ClientConnectorSubsystem = "/Game/Blueprints/Connector/BP_ClientConnectorSubsystem.BP_ClientConnectorSubsystem_C"

function _M.GetClientConnectorSubsystemClass()
    if UE.UHiUtilsFunctionLibrary.IsLinuxPlatform() or UE.UHiUtilsFunctionLibrary.IsServerPackage() then
        return nil
    end
    if _M.ClientConnectorSubsystemClass == nil then
        _M.ClientConnectorSubsystemClass = UE.UObject.Load(_M.ClientConnectorSubsystem)
        UE.UHiUtilsFunctionLibrary.AddBlueprintTypeToCache(_M.ClientConnectorSubsystem, _M.ClientConnectorSubsystemClass)
    end
    return _M.ClientConnectorSubsystemClass
end
...
_M.MissionEventActorHit = "311027"
...
_M.MissionEventAreaAbilityReceive = "311029"
