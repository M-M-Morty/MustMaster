...
---区域能力图标
function WBP_HUD_SkillState:SetAreaAbilityIcon(picKey)
    if picKey and picKey ~= "" then
        self.AreaPower_Action_Button:SetIcon(picKey)
    else
        self.AreaPower_Action_Button.Img_Skill_Icon:SetBrushFromSoftTexture(self.AreaPower_Action_Button.IconPath, true)
    end
end
