...
function M:InitPanel(npcChatManager)
    ...
    if player ~= nil and player.PlayerState.MissionAvatarComponent ~= nil then
        player.PlayerState.MissionAvatarComponent.OnDialogueUpdate:Add(self, self.OnDialogueUpdate)
    end
...
function M:OnDialogueUpdate(SmsActorID)
    ...
    local dialogue = player.PlayerState.MissionAvatarComponent.SmsDialogues[SmsActorID]
