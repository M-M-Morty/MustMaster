...
local BTTask_PlayInitAnimation = Class(BTTask_Base)
local BTTask_PlayAnim = require("ai.BTTask.BTTask_HI_PlayAnim")


-- 播放初始化动作
function BTTask_PlayInitAnimation:Execute(Controller, Pawn)
...
function BTTask_PlayInitAnimation:Tick(Controller, Pawn, DeltaSeconds)
    return self.AnimInstance:Tick(Controller, Pawn, DeltaSeconds)
end


return BTTask_PlayInitAnimation
