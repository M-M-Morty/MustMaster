...
GAMultiStage.__replicates = {
}

function GAMultiStage:K2_PostTransfer()
    Super(GAMultiStage).K2_PostTransfer(self)
end
...
UE.DistributedDSLua.RegisterCustomClass("GAMultiStage", GAMultiStage, GAPlayerBase)
