...
public:
	...
	UFUNCTION(BlueprintCallable, Category="Ability")
	FGameplayAbilitySpecHandle GetActiveAnimatingAbilityHandle();

	UFUNCTION(BlueprintCallable, Category="Ability")
	UGameplayAbility* GetAbilityInstanceFromAbilityHandle(const FGameplayAbilitySpecHandle AbilitySpecHandle);
