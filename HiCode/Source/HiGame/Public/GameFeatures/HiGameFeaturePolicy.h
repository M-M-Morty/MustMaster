...
#include "HiGameFeaturePolicy.generated.h"
...
class UHiGameFeaturePolicy : public UDefaultGameFeaturesProjectPolicies
{
	GENERATED_BODY()
public:
	HIGAME_API static UHiGameFeaturePolicy& Get();
	
	UHiGameFeaturePolicy(const FObjectInitializer& ObjectInitializer);
...
UCLASS()
class UHiGameFeature_HotfixManager : public UObject, public IGameFeatureStateChangeObserver
{
	GENERATED_BODY()
public:
...
UCLASS()
class UHiGameFeature_AddGameplayCuePaths : public UObject, public IGameFeatureStateChangeObserver
{
	GENERATED_BODY()
public:
