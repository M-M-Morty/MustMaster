...
bool UHiCollisionLibrary::CapsuleTraceSingleForObjects(const UObject* WorldContextObject, const FVector Start,
	const FVector End, const FRotator Orientation, float Radius, float HalfHeight,
...
#if ENABLE_DRAW_DEBUG
	HiDrawDebugCapsuleTraceSingle(World, Start, End, Radius, HalfHeight, DrawDebugType, bHit, OutHit, TraceColor, TraceHitColor, DrawTime);
#endif
