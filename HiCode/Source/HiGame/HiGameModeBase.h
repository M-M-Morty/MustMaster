...
public:
	...
	virtual void RemoveInactivePlayer(APlayerState* PlayerState);
	virtual APlayerState* PopInactivePlayer(uint64 EntityID);
	virtual void RestartPlayerAtPlayerStart(AController* NewPlayer, AActor* StartSpot) override;
private:
	UPROPERTY()
	TMap<uint64, TObjectPtr<class AHiPlayerState>> InactivePlayers;
	//////////////////// DS reconnection end
