...
---@class WBP_Common_Popup_Medium : WBP_Common_Popup_Medium_C

---@type WBP_Common_Popup_Medium
local WBP_Common_Popup_Medium = UnLua.Class()

---需要父Window调用播放，建议在OnShow调用
function WBP_Common_Popup_Medium:PlayInAnim()
...
function WBP_Common_Popup_Medium:PlayOutAnim()
    self:PlayAnimation(self.DX_Out, 0, 1, UE.EUMGSequencePlayMode.Forward, 1, false)
end

return WBP_Common_Popup_Medium
