...
local function OnClickSpecial(self)
    G.log:debug('zys', '<<<<<<OnClickSpecial...')
end

---@param self WBP_HUD_SkillState
local function OnClickMirror(self)
    G.log:debug('zys', '<<<<<<OnClickMirror...')
end
...
function WBP_HUD_SkillState:OnConstruct()
    self.WBP_ComBtn_Special.Button.OnClicked:Add(self, OnClickSpecial)
    self.WBP_ComBtn_Mirror.Button.OnClicked:Add(self, OnClickMirror)
...
function WBP_HUD_SkillState:Destruct()
    self.WBP_ComBtn_Special.Button.OnClicked:Remove(self, OnClickSpecial)
    self.WBP_ComBtn_Mirror.Button.OnClicked:Remove(self, OnClickMirror)
end
...
---@param bShow boolean
function WBP_HUD_SkillState:UpdateInteractionSpecial(bShow)
    self.Cvs_Interaction_Special:SetVisibility(bShow and UE.ESlateVisibility.SelfHitTestInvisible or
    UE.ESlateVisibility.Collapsed)
end

---@param bShow boolean
function WBP_HUD_SkillState:UpdateInteractionMirror(bShow)
    self.Cvs_Interaction_Mirror:SetVisibility(bShow and UE.ESlateVisibility.SelfHitTestInvisible or
    UE.ESlateVisibility.Collapsed)
end
...
function WBP_HUD_SkillState:InitWidget()
    ...
    self:UpdateInteractionSpecial(false)
    self:UpdateInteractionMirror(false)
end
