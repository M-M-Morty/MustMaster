...
#include "GameFeatures/GameFeatureAction_AddLevelInstances.h"
...
#define LOCTEXT_NAMESPACE "HiGameFeatures"
//////////////////////////////////////////////////////////////////////
...
ULevelStreamingDynamic* UGameFeatureAction_AddLevelInstances::LoadDynamicLevelForEntry(const FGameFeatureLevelInstanceEntry& Entry, UWorld* TargetWorld)
{
	...
	if (!bSuccess)
	{
		UE_LOG(LogHiGame, Error, TEXT("[GameFeatureData %s]: Failed to load level instance `%s`."), *GetPathNameSafe(this), *Entry.Level.ToString());
	}
