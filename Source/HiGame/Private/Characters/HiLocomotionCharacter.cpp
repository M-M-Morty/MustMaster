...
void AHiLocomotionCharacter::TriggerLandedAutoJump_Implementation(float RootMotionScale, float PlayRate)
{
	bTriggerLandedAutoJump = true;
	LandedAutoJumpBeginRootMotionScale = RootMotionScale;
	LandedAutoJumpBeginPlayRate = PlayRate;
	Server_TriggerLandedAutoJump(RootMotionScale, PlayRate);
}
...
void AHiLocomotionCharacter::Server_TriggerLandedAutoJump_Implementation(float RootMotionScale, float PlayRate)
{
	bTriggerLandedAutoJump = true;
	LandedAutoJumpBeginRootMotionScale = RootMotionScale;
	LandedAutoJumpBeginPlayRate = PlayRate;
