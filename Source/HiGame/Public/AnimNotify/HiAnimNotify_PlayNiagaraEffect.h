...
#include "HiAnimNotify_PlayNiagaraEffect.generated.h"
...
UCLASS(const, hidecategories = Object, collapsecategories, meta = (DisplayName = "Hi Play Niagara Particle Effect"))
class HIGAME_API UHiAnimNotify_PlayNiagaraEffect : public UAnimNotifyState
{
	GENERATED_BODY()
