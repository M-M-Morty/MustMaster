...
#include "HiAILocomotionAppearance.generated.h"

/**
 * 
 */
UCLASS(BlueprintType)
class HIGAME_API UHiAILocomotionAppearance : public UHiLocomotionComponent
{
	GENERATED_BODY()
	
public:
	UHiAILocomotionAppearance(const FObjectInitializer& ObjectInitializer);
