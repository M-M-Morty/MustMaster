...
public class HiGame : ModuleRules
{
    public HiGame(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        if (Directory.Exists(Path.Combine(ModuleDirectory, "../../Plugins/Cameras/GameplayCameras")))
        {
            PublicDefinitions.Add("WITH_PLUGINS_GAMEPLAYCAMERAS=1");
            PublicDependencyModuleNames.AddRange(
            new string[]
            {
                "GameplayCameras",
        ...
        {
            PublicDefinitions.Add("WITH_PLUGINS_GAMEPLAYCAMERAS=0");
        }
